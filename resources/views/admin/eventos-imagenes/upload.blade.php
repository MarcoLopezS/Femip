                    ...
                    <div class="panel panel-info" style="overflow:auto;">
                        ...
                        <div class="panel-body" style="padding:0px !important;">
                            <div class="col-md-12" style="padding:30px; float:center;">
                                {!! Form::open(['route' => ['admin.eventos.img.store', $posts->id], 'method' => 'POST', 'class' => 'dropzone']) !!}
                                {!! Form::close() !!}
                            </div>
                        </div>
                    </div>

                    <a href="{{ route('admin.eventos.img.list', $posts->id) }}" class="btn btn-primary">Ver fotos</a>
