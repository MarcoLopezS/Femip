            ...
            <div class="portlet box blue-hoki borderNone">
                ...
                <div class="portlet-body">   
                    ...
                    <div class="table-toolbar">
                        ...
                        <div class="btn-group">
                            <a href="{{ route('admin.eventos.tour.create', $posts->id) }}" class="btn green">
                                Agregar registro
                    ...
                    <div class="table-toolbar">
                        ...
                        {!! Form::open(['route' => ['admin.eventos.tour.order', $posts->id], 'method' => 'POST', 'id' => 'FormOrder']) !!}

                        <ul id="listPhotos" class="unstyled">

                            @foreach($photos as $item)
                            {{-- */
                            $url_editar = route('admin.eventos.tour.edit', [$posts->id, $item->id]);
...
{!! Form::open(['route' => ['admin.eventos.tour.delete', $posts->id, ':REGISTER'], 'method' => 'DELETE', 'id' => 'FormDeleteRow']) !!}
{!! Form::close() !!}
