...
<div class="row">
	...
	<div class="col-lg-12">
        ...
        <div class="row">
            ...
            {!! Form::model($post, ['route' => ['admin.eventos.update', $post->id], 'method' => 'PUT', 'files' => 'true', 'id' => 'formRegister']) !!}
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <div class="col-md-12 text-right">
                            ...
                            <a href="{{ route('admin.eventos.index') }}" class="btn btn-responsive btn-default btn-md">Cancelar</a>
                        </div>
                    </div>
