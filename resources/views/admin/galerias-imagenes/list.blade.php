            ...
            <div class="portlet box blue-hoki borderNone">
                ...
                <div class="portlet-body">   
                    ...
                    <div class="table-toolbar">
                        ...
                        <div class="btn-group">
                            <a href="{{ route('admin.galerias.img.create', $posts->id) }}" class="btn green">
                                Agregar registro
                    ...
                    <div class="table-toolbar">
                        ...
                        {!! Form::open(['route' => ['admin.galerias.img.order', $posts->id], 'method' => 'POST', 'id' => 'FormOrder']) !!}
...
{!! Form::open(['route' => ['admin.galerias.img.delete', $posts->id, ':REGISTER'], 'method' => 'DELETE', 'id' => 'FormDeleteRow']) !!}
{!! Form::close() !!}
