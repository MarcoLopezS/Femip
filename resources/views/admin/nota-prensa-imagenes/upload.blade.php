                    ...
                    <div class="panel panel-info" style="overflow:auto;">
                        ...
                        <div class="panel-body" style="padding:0px !important;">
                            <div class="col-md-12" style="padding:30px; float:center;">
                                {!! Form::open(['route' => ['admin.nota-prensa.img.store', $posts->id], 'method' => 'POST', 'class' => 'dropzone']) !!}
                                {!! Form::close() !!}
                            </div>
                        </div>
                    </div>

                    <a href="{{ route('admin.nota-prensa.img.list', $posts->id) }}" class="btn btn-primary">Ver fotos</a>
                    <a href="{{ route('admin.nota-prensa.index') }}" class="btn btn-primary">Ir a lista de noticias</a>
