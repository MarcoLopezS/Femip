...
<div class="row">
    ...
    <div class="col-lg-12">
        ...
        <div class="row">
            ...
            {!! Form::open(['route' => 'admin.nota-prensa.store', 'method' => 'POST', 'files' => 'true', 'id' => 'formRegister']) !!}
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <div class="col-md-12 text-right">
                            ...
                            <a href="{{ route('admin.nota-prensa.index') }}" class="btn btn-responsive btn-default btn-md">Cancelar</a>
                        </div>
                    </div>
                </div>
