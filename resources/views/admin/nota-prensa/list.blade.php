			...
			<div class="portlet box blue-hoki">
				...
				<div class="portlet-body">
                    ...
                    <div class="table-toolbar">
                        ...
                        <div class="btn-group">
                            <a href="{{ route('admin.nota-prensa.create') }}" class="btn green">
                                Agregar registro
                    ...
                    {!! Form::model(Request::all(), ['route' => 'admin.nota-prensa.index', 'method' => 'GET']) !!}
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center col-md-2">
                                        ...
                                        <a href="{!! route('admin.nota-prensa.index') !!}" class="btn btn-danger">
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="{{ route('admin.nota-prensa.edit', $item->id) }}">Editar</a></li>
                                            <li><a href="#delete" class="btn-delete">Eliminar</a></li>
                                            <li><a href="{{ route('admin.nota-prensa.img.list', $item->id) }}">Imagenes</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
...
{!! Form::open(['route' => ['admin.nota-prensa.destroy', ':REGISTER'], 'method' => 'DELETE', 'id' => 'FormDeleteRow']) !!}
{!! Form::close() !!}
