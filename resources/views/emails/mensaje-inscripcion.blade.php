                        ...
                        <table class="column" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;width: 100%;vertical-align: top;">
                            ...
                            <tr>
                                <td class="column_cell font_default" align="center" valign="top" style="padding: 16px;font-family: Helvetica, Arial, sans-serif;font-size: 15px;text-align: center;vertical-align: top;color: #888888;">
                                    <h4 style="font-family: Helvetica, Arial, sans-serif;margin-left: 0;margin-right: 0;margin-top: 16px;margin-bottom: 8px;padding: 0;font-size: 22px;line-height: 30px;font-weight: bold;color: #666666;">{{ $inscripcion->asoc_nombre }}</h4>
                                    <p class="lead" style="font-family: Helvetica, Arial, sans-serif;font-size: 19px;line-height: 27px;margin-top: 16px;margin-bottom: 16px;">Ha llenado la ficha de inscripción:</p>
                                </td><!-- /.column_cell -->
                            </tr>
                            </tbody>
                        </table><!-- /.column -->
                        ...
                        <table class="column" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;width: 100%;vertical-align: top;">
                            ...
                            <tr>
                                <td class="column_cell font_default" align="center" valign="top" style="padding: 16px;font-family: Helvetica, Arial, sans-serif;font-size: 15px;text-align: left;vertical-align: top;color: #888888;">
                                    <h5 style="font-family: Helvetica, Arial, sans-serif;margin-left: 0;margin-right: 0;margin-top: 16px;margin-bottom: 8px;padding: 0;font-size: 18px;line-height: 26px;font-weight: bold;color: #666666;">Datos de la Asociación</h5>
                                    <p style="font-family: Helvetica, Arial, sans-serif;font-size: 15px;line-height: 23px;margin-top: 16px;margin-bottom: 24px;"><strong>Nombre: </strong>{{ $inscripcion->asoc_nombre }}</p>
                                    <p style="font-family: Helvetica, Arial, sans-serif;font-size: 15px;line-height: 23px;margin-top: 16px;margin-bottom: 24px;"><strong>País: </strong>{{ $inscripcion->asoc_pais }}</p>
                                    <p style="font-family: Helvetica, Arial, sans-serif;font-size: 15px;line-height: 23px;margin-top: 16px;margin-bottom: 24px;"><strong>ZIP / Codigo postal: </strong>{{ $inscripcion->asoc_zip }}</p>
                                    <p style="font-family: Helvetica, Arial, sans-serif;font-size: 15px;line-height: 23px;margin-top: 16px;margin-bottom: 24px;"><strong>Dirección: </strong>{{ $inscripcion->asoc_direccion }}</p>
                                    <p style="font-family: Helvetica, Arial, sans-serif;font-size: 15px;line-height: 23px;margin-top: 16px;margin-bottom: 24px;"><strong>Teléfono: </strong>{{ $inscripcion->asoc_telefono }}</p>
                                    <p style="font-family: Helvetica, Arial, sans-serif;font-size: 15px;line-height: 23px;margin-top: 16px;margin-bottom: 24px;"><strong>Email: </strong>{{ $inscripcion->rep_email }}</p>
                                    <p style="font-family: Helvetica, Arial, sans-serif;font-size: 15px;line-height: 23px;margin-top: 16px;margin-bottom: 24px;"><strong>Asociados: </strong>{{ $inscripcion->asoc_numero }}</p>
                                    <br>

                                    <h5 style="font-family: Helvetica, Arial, sans-serif;margin-left: 0;margin-right: 0;margin-top: 16px;margin-bottom: 8px;padding: 0;font-size: 18px;line-height: 26px;font-weight: bold;color: #666666;">Datos del Representante de la Asociación</h5>
                                    <p style="font-family: Helvetica, Arial, sans-serif;font-size: 15px;line-height: 23px;margin-top: 16px;margin-bottom: 24px;"><strong>Cargo: </strong>{{ $inscripcion->rep_cargo }}</p>
                                    <p style="font-family: Helvetica, Arial, sans-serif;font-size: 15px;line-height: 23px;margin-top: 16px;margin-bottom: 24px;"><strong>Nombre: </strong>{{ $inscripcion->rep_nombre }}</p>
                                    <p style="font-family: Helvetica, Arial, sans-serif;font-size: 15px;line-height: 23px;margin-top: 16px;margin-bottom: 24px;"><strong>Dirección: </strong>{{ $inscripcion->rep_direccion }}</p>
                                    <p style="font-family: Helvetica, Arial, sans-serif;font-size: 15px;line-height: 23px;margin-top: 16px;margin-bottom: 24px;"><strong>Teléfono: </strong>{{ $inscripcion->rep_telefono }}</p>
                                    <p style="font-family: Helvetica, Arial, sans-serif;font-size: 15px;line-height: 23px;margin-top: 16px;margin-bottom: 24px;"><strong>Email: </strong>{{ $inscripcion->rep_email }}</p>
                                </td><!-- /.column_cell -->
                            </tr>
                            </tbody>
